"""
Anima - Authentication, RBAC & OTP.

Owns the /api/auth router (register, login, verify-otp) and the RBAC-gated
/api/patients clinician view. Enforces the role-prefixed user_ID convention and
issues one-time passcodes for the PowerApps/Outlook client to email.
"""
...
from security import hash_password, verify_password, decrypt_value

logger = logging.getLogger("anima.auth")
...
# Routers
# =============================================================================
# Maps to the "FastAPI Router" layer in the system architecture.
